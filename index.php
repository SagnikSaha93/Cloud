    ...
    <td valign="top"><form action="login.php" method="post">
      <table width="200" border="0">
        <tr>
          ...
          <td><input type="email" name="f3"  required="true" autocomplete="off"></td>
        </tr>
        <tr>
          <td><span class="style2">Password</span></td>
          <td><input type="password" name="f4"  required="true"></td>
        </tr>
        <tr cellpadding="2"><td colspan="2"></td></tr>
        <tr>
            <td colspan="2"><span class="style2">Select User</span>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <select name="user"  id="pass2" style="width: 120px" required="true">
           <option>User</option>
            <option>Admin</option>    
          </select></td>
        </tr>
